                ...
                <el-dialog title="新增" :visible.sync="dialogVisible2" width="50%" :before-close="handleClose" center modal>
                    ...
                    <el-form :model="row" :rules="rules" ref="row" label-width="100px" class="demo-ruleForm">
                        <el-form-item label="用户id" prop="uid">
                            <el-input v-model="row.uid"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="状态" prop="count">
                            <el-select v-model="value" clearable>
                                <el-option v-for="(item, index) in 2" :key="index" :label="count" :value="index">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="会员级别" prop="rank_type">
                            <el-input v-model="row.rank_type"></el-input>
                        </el-form-item>
                        <el-form-item>
            ...
            <el-table :data="data.slice(
                ...
                <el-table-column label="状态" prop="count">
                    <template slot-scope="scoped">
                        <el-switch v-model="scoped.row.count" inactive-color="#13ce66" active-color="#ff4949"
                ...
                <el-table-column label="会员级别" prop="MLevel">
                </el-table-column>
            ...
            <div class="editor">
                <el-dialog title="编辑" :visible.sync="dialogVisible1" width="50%" :before-close="handleClose" center modal>
                    ...
                    <el-form :model="row" :rules="rules" ref="row" label-width="100px" class="demo-ruleForm">
                        ...
                        <el-form-item label="状态" prop="count">
                            <el-select v-model="row.count" clearable placeholder="请选择">
                                <el-option v-for="(item, index) in 2" :key="index" :label="row.count" :value="index">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="会员级别" prop="rank_type">
                            <el-select v-model="row.rank_type" clearable placeholder="请选择">
                                <el-option v-for="(item, index) in 4" :key="index" :label="row.rank_type" :value="item">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="注册时间" prop="createTime">
                            <el-input v-model="row.createTime" disabled="true"></el-input>
                        </el-form-item>
                        <el-form-item>
